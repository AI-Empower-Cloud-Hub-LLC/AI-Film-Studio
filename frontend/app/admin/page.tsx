      ...
      <div className="pl-64">
        <div className="px-8 py-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <button
              onClick={fetchStats}
              className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700/50 rounded-lg text-gray-600 dark:text-gray-300 text-sm hover:bg-gray-50 dark:hover:bg-gray-700/60 transition-colors shadow-sm dark:shadow-none"
            >
